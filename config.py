...
OWNER_USERNAME = getenv("OWNER_USERNAME","Nayan")
BOT_USERNAME = getenv("BOT_USERNAME" , "jiyaaprobot")
BOT_NAME = getenv("BOT_NAME" , "Jiyaa Music Bot")
ASSUSERNAME = getenv("ASSUSERNAME" , "Rocky_EDF")
MONGO_DB_URI = getenv("MONGO_DB_URI", None)
DURATION_LIMIT_MIN = int(getenv("DURATION_LIMIT", 17000))
LOGGER_ID = int(getenv("LOGGER_ID", -1002188699242))
OWNER_ID = int(getenv("OWNER_ID", 6801018150))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/friendshipgrouplinkk")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/+l-ybt8uW6Tc1YWY1")
